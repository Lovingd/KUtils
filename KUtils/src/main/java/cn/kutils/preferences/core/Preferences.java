...
package cn.kutils.preferences.core;
...
import static cn.kutils.preferences.core.TrayLog.v;
import static cn.kutils.preferences.core.TrayLog.w;
...
public abstract class Preferences<T, S extends PreferenceStorage<T>>
    ...
    @Override
    public boolean put(@NonNull final String key, final Object value) {
