 ...
 */
public class Boxing {
    public static final String EXTRA_SELECTED_MEDIA = "cn.kutils.boxing.Boxing.selected_media";
    public static final String EXTRA_ALBUM_ID = "cn.kutils.boxing.Boxing.album_id";

    static final String EXTRA_CONFIG = "cn.kutils.boxing.Boxing.config";
    static final String EXTRA_RESULT = "cn.kutils.boxing.Boxing.result";
    static final String EXTRA_START_POS = "cn.kutils.boxing.Boxing.start_pos";
    ...
    public interface OnBoxingFinishListener {
        ...
        /**
         * live with {@link cn.kutils.boxing.presenter.PickerContract.View#onFinish(List)}
         *
